...
export default function PostLostPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.location.trim()) return toast.error('Lost location is required');
    if (!formData.date) return toast.error('Date lost is required');
    if (!formData.personName.trim()) return toast.error('Your name is required');
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-extrabold tracking-tight text-foreground">Report a Lost Item</h1>
        <p className="text-sm text-muted-foreground mt-2">
          Provide as much detail as possible to help the campus community identify and return your item.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <Input
              type="text"
              name="location"
              placeholder="e.g. Central Library 2nd Floor, Room A-102"
          ...
          <div className="sm:col-span-2">
            ...
            <Textarea
              name="description"
              rows={4}
              placeholder="Describe details like color, brand, distinct marks, or contents of the item..."
